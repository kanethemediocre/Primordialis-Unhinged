...
function M.post(api, config)
	...
	creature_list = function(...)
		...
		register_creature(
			...
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/SNAILBOMB.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.snail2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/SNAIL2.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.snail3"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/SNAIL3.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.snail4"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/SNAIL4.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.snail5"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/SNAIL5.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_hard"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_hard1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_basic"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_basic1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_spike1"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_spike1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_spike2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_spike2.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_poison"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_poison1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_venom"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_venom1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.caterpillar_light"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/caterpillar_light1.bod",
			"snail_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.antenna_bug2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/antenna_bug2.bod",
			"default_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.grub2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/grub2.bod",
			"default_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.shield_crab2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/shield_crab2.bod",
			"default_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.starfox_boss"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/starfoxboss1.bod",
			"primordialis_unginged.donothing_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.chariot2"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/chariot2.bod",
			"default_brain"
		)
		register_creature(
			api.acquire_id("primordialis_unginged.autosnek"),
			"data/scripts/lua_mods/Primordialis-Unhinged/body plans/autosnek1.bod",
			"primordialis_unginged.donothing_brain"
		)
