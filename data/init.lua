...
function init_biomes()
	...
	add_creature_spawn_chance("SAFE", "CATH", 0.04, 2)
	...
	add_creature_spawn_chance("STRT", "SNY2", 0.03, 5)
	add_creature_spawn_chance("STRT", "SNY3", 0.03, 6)
	add_creature_spawn_chance("STRT", "SNY4", 0.03, 4)
    add_creature_spawn_chance("STRT", "PCTT", 0.02, 3)
	
	add_creature_spawn_chance("STRT", "CATH", 0.04, 2)
	add_creature_spawn_chance("STRT", "CATS", 0.02, 2)
	add_creature_spawn_chance("STRT", "CATP", 0.02, 2)
