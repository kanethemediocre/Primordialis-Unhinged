...
function init_biomes()
	...
	add_creature_spawn_chance("SAFE", "CATH", 0.06, 2)
    ...
    add_creature_spawn_chance("STRT", "GRUB", 0.06, 1)
    add_creature_spawn_chance("STRT", "AANT", 0.06, 1)
    add_creature_spawn_chance("STRT", "SNYL", 0.04, 3)
	add_creature_spawn_chance("STRT", "SNY2", 0.02, 5)
	add_creature_spawn_chance("STRT", "SNY3", 0.02, 6)
	add_creature_spawn_chance("STRT", "SNY4", 0.02, 4)
    add_creature_spawn_chance("STRT", "PCTT", 0.02, 3)
	
	add_creature_spawn_chance("STRT", "CATH", 0.04, 3)
	add_creature_spawn_chance("STRT", "CATS", 0.01, 3)
	add_creature_spawn_chance("STRT", "CATP", 0.02, 3)
	...
	add_creature_spawn_chance("STRT", "CATS", 0.01, 3)
	add_creature_spawn_chance("STRT", "CATP", 0.01, 3)
