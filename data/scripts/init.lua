...
function init_biomes()
	...
	add_creature_spawn_chance("STRT", "AAN2", 0.04, 4)
	...
	add_creature_spawn_chance("STRT", "SNYL", 0.02, 3)
	add_creature_spawn_chance("STRT", "SNYB", 0.001, 3)
	...
	add_creature_spawn_chance("ICEE", "SNK1", 0.03, 2)
	...
	add_creature_spawn_chance("DARK", "CATL", 0.05, 3)
	add_creature_spawn_chance("ICEE", "CATH", 0.02, 3)
