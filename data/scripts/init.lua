...
function creature_list()
	...
	register_creature("SHC2", "body plans/shield_crab2","default_brain")
	register_creature("SFOX", "body plans/starfoxboss1","donothing_brain")
	register_creature("CHR2", "body plans/chariot2","default_brain")
end
...
function init_biomes()
    ...
    add_creature_spawn_chance("STRT", "JSQD", 0.008, 3)
    ...
    add_creature_spawn_chance("STRT", "CHRT", 0.005, 6)
	add_creature_spawn_chance("STRT", "CHR2", 0.005, 6)
    add_creature_spawn_chance("STRT", "SCRP", 0.005, 9)
    add_creature_spawn_chance("STRT", "GRUB", 0.03, 1)
	add_creature_spawn_chance("STRT", "GRU2", 0.03, 1)
    add_creature_spawn_chance("STRT", "AANT", 0.02, 3)
	add_creature_spawn_chance("STRT", "AAN2", 0.02, 3)
	...
	add_creature_spawn_chance("STRT", "CATS", 0.02, 2)
	add_creature_spawn_chance("STRT", "CATP", 0.02, 1)
	...
	add_creature_spawn_chance("STRT", "SNYL", 0.02, 3)
	add_creature_spawn_chance("STRT", "SNYB", 0.002, 3)
	...
	add_creature_spawn_chance("ICEE", "CTS2", 0.01, 3)
	...
	add_creature_spawn_chance("DARK", "CATL", 0.01, 3)
